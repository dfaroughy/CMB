...
class DiscreteStateMLP(nn.Module):
    ...
    def define_deep_models(self, config):
        ...
        if hasattr(config, "time_embedding"):
            ...
            elif config.time_embedding == "randomfourier":
        ...
        self.state_embedding = nn.Sequential(
            nn.Embedding(self.vocab_size, self.dim_discrete_emb),
        ...
        self.layers = fc_block(
            dim_input=self.dim_discrete_emb + self.dim_time_emb + self.dim_context_emb,
